  ...
  return (
    <div className={cardClasses.trim()}>
      ...
      <div className="my-6 flex items-baseline gap-2">
        <span className="text-[48px] font-extralight text-foreground font-display">{price === 'Custom' ? 'Custom' : price}</span>
        <span className="text-[14px] text-foreground/70 font-sans">{price === 'Custom' ? '' : '/mo'}</span>
      </div>
